...
class GTH(LiteXModule):
    def __init__(self, pll, tx_pads, rx_pads, sys_clk_freq, tx_clk=None, rx_clk=None,
        ...
        use_qpll = isinstance(pll, GTHQuadPLL)
    ...
    def add_electrical_control(self):
        ...
        self._tx_precursor_inv  = CSRStorage(1, reset=0b0,     description="Invert polarity of TX Pre Cursor, see UG476.")
        self.gth_params.update(
    ...
    def do_finalize(self):
        self.specials += Instance("GTHE2_CHANNEL", **self.gth_params)
